...
/usr/local/spark/bin/spark-submit --master yarn --deploy-mode client --driver-memory 3g --executor-memory 2g --executor-cores 3 --num-executors 10 train.py output.txt
